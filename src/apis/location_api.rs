...
pub async fn get_bulk_ip_location(configuration: &configuration::Configuration, request_body: Vec<String>) -> Result<(), Error<GetBulkIpLocationError>> {
...
pub async fn get_ip_location(configuration: &configuration::Configuration, ip: &str) -> Result<(), Error<GetIpLocationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_ip = ip;
...
pub async fn get_network_location(configuration: &configuration::Configuration, network: &str) -> Result<(), Error<GetNetworkLocationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_network = network;

    let uri_str = format!("{}/v1/location/network/{*network}", configuration.base_path, network=crate::apis::urlencode(p_path_network));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn search_location(configuration: &configuration::Configuration, field: &str, value: &str, limit: Option<i32>) -> Result<(), Error<SearchLocationError>> {
    // add a prefix to parameters to efficiently prevent name collisions

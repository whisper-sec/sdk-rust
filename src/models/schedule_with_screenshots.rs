...
/// ScheduleWithScreenshots : A schedule with its captured screenshots
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScheduleWithScreenshots {
    /// Schedule ID
    ...
    pub screenshots: Option<Vec<models::ScreenshotEntry>>,
}

impl ScheduleWithScreenshots {
    /// A schedule with its captured screenshots
    pub fn new() -> ScheduleWithScreenshots {

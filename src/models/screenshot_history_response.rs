...
/// ScreenshotHistoryResponse : Response containing screenshot history for a target URL
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScreenshotHistoryResponse {
    ...
    pub schedules: Option<Vec<models::ScheduleWithScreenshots>>,
    /// Total number of screenshots available for this target
    #[serde(rename = "total_screenshots", skip_serializing_if = "Option::is_none")]
    pub total_screenshots: Option<i32>,
    /// Maximum number of screenshots returned (limit parameter)
    #[serde(rename = "limit", skip_serializing_if = "Option::is_none")]
    pub limit: Option<i32>,
}

impl ScreenshotHistoryResponse {
    /// Response containing screenshot history for a target URL
    pub fn new() -> ScreenshotHistoryResponse {

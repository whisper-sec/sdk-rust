...
/// MonitoringMetrics : Monitoring metrics and statistics for the target
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MonitoringMetrics {
    /// Uptime percentage over the last 30 days
    #[serde(rename = "uptimePercentage", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "sslExpiresInDays", skip_serializing_if = "Option::is_none")]
    pub ssl_expires_in_days: Option<i32>,
    /// Number of DNS change events detected
    #[serde(rename = "dnsChangeCount", skip_serializing_if = "Option::is_none")]
    pub dns_change_count: Option<i32>,
    /// Number of WHOIS change events detected
    #[serde(rename = "whoisChangeCount", skip_serializing_if = "Option::is_none")]
    pub whois_change_count: Option<i32>,
    /// Timestamp of last successful check
    #[serde(rename = "lastCheckAt", skip_serializing_if = "Option::is_none")]
...
impl MonitoringMetrics {
    ...
    pub fn new() -> MonitoringMetrics {
        MonitoringMetrics {
            uptime_percentage: None,
            avg_response_time: None,
            ssl_expires_in_days: None,
            dns_change_count: None,
            whois_change_count: None,
            last_check_at: None,
            current_status: None,
        }
    }

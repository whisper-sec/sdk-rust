...
/// BulkIpLocationRequest : Request for bulk IP geolocation lookup
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BulkIpLocationRequest {
    /// List of IP addresses to lookup
    #[serde(rename = "ips")]
    pub ips: Vec<String>,
}

impl BulkIpLocationRequest {
    /// Request for bulk IP geolocation lookup
    pub fn new(ips: Vec<String>) -> BulkIpLocationRequest {

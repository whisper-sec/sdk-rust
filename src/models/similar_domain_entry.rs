...
/// SimilarDomainEntry : A single similar domain entry with its detection technique
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SimilarDomainEntry {
...
impl SimilarDomainEntry {
    /// A single similar domain entry with its detection technique
    pub fn new(domain: String, technique: Technique) -> SimilarDomainEntry {
        SimilarDomainEntry {
            domain,
            technique,
        }
...
pub enum Technique {
    #[serde(rename = "TYPO")]
    Typo,
    #[serde(rename = "UTFVARS")]
    Utfvars,
    #[serde(rename = "TLD_VARIANTS")]
    TldVariants,
    #[serde(rename = "SOUNDING")]
    Sounding,
    #[serde(rename = "PREFIX")]
    Prefix,
    #[serde(rename = "SUFFIX")]

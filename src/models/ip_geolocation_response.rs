...
/// IpGeolocationResponse : Geolocation and network information for an IP address
...
impl IpGeolocationResponse {
    ...
    pub fn new() -> IpGeolocationResponse {

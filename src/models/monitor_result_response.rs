...
/// MonitorResultResponse : Result of a single check execution
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MonitorResultResponse {
    ...
    #[serde(rename = "hasErrors", skip_serializing_if = "Option::is_none")]
    pub has_errors: Option<bool>,
}

impl MonitorResultResponse {
    /// Result of a single check execution
    pub fn new() -> MonitorResultResponse {

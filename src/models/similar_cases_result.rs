...
/// SimilarCasesResult : Result of ML-based similar case matching
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SimilarCasesResult {
    ...
    #[serde(rename = "similarCases", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub similar_cases: Option<Option<serde_json::Value>>,
}

impl SimilarCasesResult {
    /// Result of ML-based similar case matching
    pub fn new() -> SimilarCasesResult {
        SimilarCasesResult {
            indicators: None,
            status: None,
            error: None,

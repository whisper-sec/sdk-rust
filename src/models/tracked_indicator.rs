...
/// TrackedIndicator : A tracked indicator with its configuration and status
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TrackedIndicator {
    ...
    #[serde(rename = "last_check_at", skip_serializing_if = "Option::is_none")]
    pub last_check_at: Option<String>,
    /// When the next check is scheduled
    #[serde(rename = "next_check_at", skip_serializing_if = "Option::is_none")]
    pub next_check_at: Option<String>,
    /// Total number of changes detected
    #[serde(rename = "total_changes", skip_serializing_if = "Option::is_none")]
    pub total_changes: Option<i32>,
}

impl TrackedIndicator {
    /// A tracked indicator with its configuration and status
    pub fn new() -> TrackedIndicator {
        TrackedIndicator {
            r#type: None,
            value: None,
            enabled: None,

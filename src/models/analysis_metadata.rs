...
/// AnalysisMetadata : Metadata about the similarity search that was performed
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AnalysisMetadata {
    /// Comma-separated list of backend similarity types that were used
    #[serde(rename = "techniquesUsed")]
    pub techniques_used: String,
...
impl AnalysisMetadata {
    ...
    pub fn new(techniques_used: String, base_domain: String, search_limit: i32) -> AnalysisMetadata {
        AnalysisMetadata {
            techniques_used,
            base_domain,
            search_limit,

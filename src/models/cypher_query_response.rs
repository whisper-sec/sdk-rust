...
/// CypherQueryResponse : Response from executing a Cypher query against the graph database.  Contains the query results as a list of records, along with execution metadata including timing and column information. 
...
impl CypherQueryResponse {
    ...
    pub fn new() -> CypherQueryResponse {
        CypherQueryResponse {
            results: None,

...
/// TraitsInfo : IP classification and behavioral traits
...
pub struct TraitsInfo {
    ...
    #[serde(rename = "isAnonymousProxy", skip_serializing_if = "Option::is_none")]
    pub is_anonymous_proxy: Option<bool>,
    /// Whether this IP is a known Tor exit node
    #[serde(rename = "isTorExitNode", skip_serializing_if = "Option::is_none")]
    pub is_tor_exit_node: Option<bool>,
    /// Whether this IP is associated with a VPN service
    #[serde(rename = "isVpn", skip_serializing_if = "Option::is_none")]
    pub is_vpn: Option<bool>,
}

impl TraitsInfo {
    /// IP classification and behavioral traits
    pub fn new() -> TraitsInfo {
        TraitsInfo {
            user_type: None,

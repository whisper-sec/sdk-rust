...
/// InvestigateResult : Result of an AI-powered threat investigation
...
pub struct InvestigateResult {
    ...
    #[serde(rename = "indicatorType", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "investigation", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub investigation: Option<Option<serde_json::Value>>,
}

impl InvestigateResult {
    /// Result of an AI-powered threat investigation
    pub fn new() -> InvestigateResult {
        InvestigateResult {
            indicator: None,
            indicator_type: None,
            status: None,

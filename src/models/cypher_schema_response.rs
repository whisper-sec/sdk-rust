...
/// CypherSchemaResponse : Graph database schema information including available node types, relationship types, and their properties.  Use this to discover what data is available for querying. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CypherSchemaResponse {
    ...
    #[serde(rename = "relationshipTypes", skip_serializing_if = "Option::is_none")]
    pub relationship_types: Option<Vec<String>>,
    /// Properties available on each node type, keyed by node label
    #[serde(rename = "nodeProperties", skip_serializing_if = "Option::is_none")]
    pub node_properties: Option<std::collections::HashMap<String, Vec<String>>>,
    /// Properties available on each relationship type, keyed by relationship type
    #[serde(rename = "relationshipProperties", skip_serializing_if = "Option::is_none")]
    pub relationship_properties: Option<std::collections::HashMap<String, Vec<String>>>,
    /// Total number of nodes in the graph
    #[serde(rename = "nodeCount", skip_serializing_if = "Option::is_none")]
    pub node_count: Option<i64>,
    /// Total number of relationships in the graph
    #[serde(rename = "relationshipCount", skip_serializing_if = "Option::is_none")]
    pub relationship_count: Option<i64>,
}

impl CypherSchemaResponse {
    ...
    pub fn new() -> CypherSchemaResponse {

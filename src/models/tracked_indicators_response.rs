...
/// TrackedIndicatorsResponse : Response containing a list of indicators being tracked for changes
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TrackedIndicatorsResponse {
    /// Total number of tracked indicators
    #[serde(rename = "count", skip_serializing_if = "Option::is_none")]
    pub count: Option<i32>,
    /// Maximum number of indicators that can be tracked per API key
    #[serde(rename = "max_tracked", skip_serializing_if = "Option::is_none")]
    pub max_tracked: Option<i32>,
    /// List of tracked indicators
    #[serde(rename = "indicators", skip_serializing_if = "Option::is_none")]
    pub indicators: Option<Vec<models::TrackedIndicator>>,
}

impl TrackedIndicatorsResponse {
    /// Response containing a list of indicators being tracked for changes
    pub fn new() -> TrackedIndicatorsResponse {

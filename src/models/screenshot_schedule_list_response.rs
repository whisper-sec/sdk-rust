...
/// ScreenshotScheduleListResponse : Response containing a list of screenshot schedules and quota information
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScreenshotScheduleListResponse {
    /// Number of schedules in this response
    #[serde(rename = "count", skip_serializing_if = "Option::is_none")]
    pub count: Option<i32>,
    /// Maximum number of schedules allowed per API key
    #[serde(rename = "max_schedules", skip_serializing_if = "Option::is_none")]
    pub max_schedules: Option<i32>,
    /// Maximum number of screenshots retained per schedule
    #[serde(rename = "max_screenshots_per_schedule", skip_serializing_if = "Option::is_none")]
    pub max_screenshots_per_schedule: Option<i32>,
    /// List of screenshot schedules
    #[serde(rename = "schedules", skip_serializing_if = "Option::is_none")]
    pub schedules: Option<Vec<models::ScreenshotSchedule>>,
}

impl ScreenshotScheduleListResponse {
    /// Response containing a list of screenshot schedules and quota information
    pub fn new() -> ScreenshotScheduleListResponse {
        ScreenshotScheduleListResponse {
            count: None,
            max_schedules: None,
            max_screenshots_per_schedule: None,
            schedules: None,
        }
    }
}

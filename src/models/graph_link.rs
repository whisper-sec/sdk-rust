...
/// GraphLink : A link/edge connecting two nodes in the infrastructure graph
...
pub enum Type {
    #[serde(rename = "resolvesTo")]
    ResolvesTo,
    #[serde(rename = "hasNameserver")]
    HasNameserver,
    #[serde(rename = "hasMailHost")]
    HasMailHost,
    #[serde(rename = "hasDomainParent")]
    HasDomainParent,
    #[serde(rename = "sameASN")]
    SameAsn,
    #[serde(rename = "sameNetwork")]
    SameNetwork,
    #[serde(rename = "sameCertificate")]
    SameCertificate,
    #[serde(rename = "sameRegistrant")]
    SameRegistrant,
    #[serde(rename = "linksTo")]
    LinksTo,

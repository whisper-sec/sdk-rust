...
/// CorrelateResult : Result of global indicator correlation analysis
...
pub struct CorrelateResult {
    ...
    #[serde(rename = "correlation", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub correlation: Option<Option<serde_json::Value>>,
}

impl CorrelateResult {
    /// Result of global indicator correlation analysis
    pub fn new() -> CorrelateResult {
        CorrelateResult {
            indicators: None,
            status: None,
            error: None,

...
/// GraphResponse : Graph visualization data showing relationships between infrastructure elements. Format is compatible with react-force-graph, vis.js, cytoscape.js, and similar libraries.
...
pub struct GraphResponse {
    ...
    pub links: Option<Vec<models::GraphLink>>,

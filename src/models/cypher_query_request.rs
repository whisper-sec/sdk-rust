...
impl CypherQueryRequest {
    ...
    pub fn new(query: String) -> CypherQueryRequest {
        CypherQueryRequest {
            query,
            parameters: None,
            limit: None,

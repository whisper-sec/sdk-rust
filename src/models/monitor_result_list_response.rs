...
/// MonitorResultListResponse : Response containing a list of check execution results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MonitorResultListResponse {
    ...
    pub results: Option<Vec<models::MonitorResultResponse>>,
}

impl MonitorResultListResponse {
    /// Response containing a list of check execution results
    pub fn new() -> MonitorResultListResponse {

...
/// PivotResult : Result of AI infrastructure pivoting
...
pub struct PivotResult {
    ...
    #[serde(rename = "pivot", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pivot: Option<Option<serde_json::Value>>,
}

impl PivotResult {
    /// Result of AI infrastructure pivoting
    pub fn new() -> PivotResult {
        PivotResult {
            indicator: None,
            indicator_type: None,
            depth: None,
